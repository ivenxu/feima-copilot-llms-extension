...
> **注意**
> 此页面已从原始文档网站迁移。相关内容已合并到[语言模型(Language Model)](/docs/copilot/concepts/language-models)页面。
...
> **💡 使用飞码国内模型**
> **[飞码扣插件](/zh/guides/quickstart)** 为 GitHub Copilot Chat 扩展了国内 AI 模型支持，包括通义千问(Qwen3 Max/Flash/Coder)、DeepSeek V3.2、智谱 GLM-5、MiniMax M2.5 和 Kimi K2.5。在模型选择器中即可看到这些模型。查看[完整模型列表](/zh/guides/using-models)。
...
了解更多：[自定义智能体(Custom Agent)](/docs/copilot/customization/custom-agents)和[语言模型(Language Model)](/docs/copilot/concepts/language-models)。
