...
有关网络配置的更多信息，请参阅 [Copilot 的网络和防火墙配置](/docs/copilot/faq#_network-and-firewall-configuration-for-copilot)。
...
了解更多：[智能体(Agent)调试日志面板](/docs/copilot/chat/chat-debug-view#_agent-debug-log-panel)。
...
了解更多：[聊天调试视图](/docs/copilot/chat/chat-debug-view#_chat-debug-view)。
...
了解更多：[配置和调试 MCP 服务器](/docs/copilot/customization/mcp-servers)。
...
- [调试聊天交互](/docs/copilot/chat/chat-debug-view)
